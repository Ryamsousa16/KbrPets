                    ...
                    <form action="" class="form w-100" method="POST">
                        ...
                        <div class="row row-gap-3">
                            <div class="col-12 form-group text-light">
                                ...
                                <input type="email" name="email" class="form-control bg-dark border-dark text-light" id="email" placeholder="example@kbrtec.com.br" required>
                            ...
                            <div class="col-12 mt-3 d-flex gap-2 align-items-center justify-content-between">
                                <button ttype="submit" class="btn btn-light">Resetar senha</button>
