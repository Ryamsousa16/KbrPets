        ...
        <main class="col h-100 text-light p-4">
            ...
            <form action="" method="POST" class="bg-custom rounded col-12 py-3 px-4">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nome" class="form-control bg-dark text-light border-dark" id="usuario" placeholder="Ex: usuario12">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="email" name="email" class="form-control bg-dark text-light border-dark" id="email" placeholder="Ex: nome.sobrenome@email.com.br">
                    </div>
                </div>
